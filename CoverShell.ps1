<#
.SYNOPSIS
A GUI (based on Windows Form) to execute some useful PowerShell functions and commands.
.DESCRIPTION
...
$ButtonST2.Add_Click({
    ...
    $out5b = try {
                ...
                " server not set or host offline"
             }
...
$Label234.Text = "Run a 'ping sweep' in the host network"
...
# Create a "Please wait..." label to introduce the Panel 3 third action
$Label235 = New-Object System.Windows.Forms.Label
$Label235.Text = "Please wait..."
...
$ButtonFIDf.Add_Click({
    ...
    $textBox3IDf.Text = "`nFILES MODIFIED (same name, different data), if present:"
...
$ButtonV.Add_Click({
    ...
    $confirmation = [System.Windows.Forms.MessageBox]::Show( "Do you really want to DELETE all the volume content and overwrite it with random data?", "Command confirmation", "YesNo", "Warning" )
